...
3. Verify that the `Cloud Student` user has already been created.
4. Navigate back to the tenant overview page, and select `Groups` from the left-hand menu.
5. Click + `New group`.
6. Leave the `Group Type` as `Security` and enter "Research & Development" for the `Group Name`.
7. Click `Create`.
...
3. Click `+ Add members`.
4. Search for "Cloud Student", and select the user.
5. Click `Select`.
6. Verify the user was added to the group.
